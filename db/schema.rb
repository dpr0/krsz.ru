...
ActiveRecord::Schema.define(version: 20_180_408_072_326) do
  ...
  create_table 'attaches', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[attachable_id attachable_type], name: 'index_attaches_on_attachable_id_and_attachable_type'
  end
